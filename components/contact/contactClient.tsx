...
const quickContact = [
  ...
  },
  {
    ...
    value: "USA · Canada · Australia · UAE",
...
const whyPoints = [
  ...
  {
    icon: RefreshCw,
    text: "No long-term lock-in contracts",
    color: "#059669",
    bg: "#d1fae5",
  },
  {
    icon: Zap,
    text: "Scalable solutions that grow with you",
    color: "#0ea5e9",
    bg: "#dbeafe",
  },
  {
    icon: Shield,
    text: "Secure & confidential processes",
    color: "#be185d",
    bg: "#fce7f3",
  },
  {
    icon: Users,
    text: "Industry-trained remote professionals",
    color: "#d97706",
    bg: "#fef3c7",
  },
  {
    icon: Clock,
    text: "24/7 global support availability",
    color: "#1d4ed8",
    bg: "#dbeafe",
  },
];
...
const faqs = [
  ...
  {
    q: "Can I combine human outsourcing with AI automation?",
...
const nextSteps = [
  {
    ...
    desc: "Our team assesses your needs immediately upon submission.",
    color: "#7c3aed",
  },
  {
    step: "02",
    title: "Consultant Reaches Out",
    desc: "A strategy consultant contacts you within 24 hours.",
    color: "#0ea5e9",
  },
  {
    step: "03",
    title: "Discovery Call",
    desc: "We dive deep into your challenges and goals together.",
    color: "#10b981",
  },
  {
    step: "04",
    title: "Custom Proposal",
    desc: "You receive a tailored plan built specifically for your business.",
    color: "#f59e0b",
  },
];
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: open ? "0 4px 24px rgba(124,58,237,0.1)" : "none",
      }}
    >
      <button
      ...
      {open && (
        <div
          className="px-6 pb-5 text-gray-500 font-light leading-relaxed border-t border-violet-100 pt-4"
...
export default function ContactClient() {
  ...
  const inputClass =
    "w-full px-4 py-3 rounded-xl border border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:border-primary transition-all duration-200 text-sm font-medium";
  const darkInputClass =
    "w-full px-4 py-3 rounded-xl border text-sm text-white placeholder-white/30 focus:outline-none transition-all font-medium";
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            <div className="text-center mb-14">
              ...
              >
                Reach Us{" "}
                <span className="font-extrabold text-primary">Anytime</span>
              </h2>
              <p className="text-gray-500 font-light max-w-xl mx-auto text-lg leading-relaxed">
                AJAX Global operates internationally — your timezone is our
                timezone.
              </p>
            </div>
          </Reveal>
                ...
                <Reveal key={i} delay={i * 0.08} direction="up">
                  <div className="group p-7 rounded-2xl border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 bg-white text-center cursor-default relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <div
                        className="inline-flex p-3.5 rounded-2xl mb-5 group-hover:scale-110 transition-transform duration-300"
                      ...
                      <p
                        className="text-xs font-extrabold uppercase tracking-[.18em] mb-2"
                        style={{ color: item.color }}
                      >
                        {item.title}
                      </p>
                      <p className="font-extrabold text-gray-900 mb-1.5 text-sm leading-snug">
                        {item.value}
                      </p>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            <div className="text-center mb-12">
              <span className="text-xs font-extrabold uppercase tracking-[.22em] text-primary block mb-3">
                Let's Talk
              </span>
              <h2
                className="text-[clamp(2rem,4.5vw,3.5rem)] font-light text-gray-900 mb-4"
              ...
              <p className="text-gray-500 font-light text-lg leading-relaxed">
                Tell us about your business and we'll craft a solution around
                your exact needs.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.1}>
            <div
              className="bg-white rounded-3xl border border-violet-100 shadow-xl p-8 sm:p-10"
              ...
              {submitted ? (
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-500 font-light">
                    Thank you for reaching out. A strategy consultant will
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-4 rounded-xl font-extrabold text-white flex items-center justify-center gap-2 transition-all duration-200 hover:scale-[1.02] hover:shadow-2xl active:scale-[0.98]"
                    style={{
                      background: "var(--primary)",
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Reveal direction="left" delay={0.08}>
              <div className="group relative rounded-3xl border-2 border-gray-100 hover:border-violet-300 p-8 transition-all duration-300 hover:shadow-2xl overflow-hidden bg-white h-full">
                <div
                  className="absolute top-0 right-0 w-48 h-48 rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none transition-colors duration-300"
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <span className="text-xs font-extrabold uppercase tracking-[.2em] text-primary mb-2 block">
                    HOS
                  </span>
                  ...
                  <p className="text-gray-500 font-light mb-6 leading-relaxed flex-1">
                    Need trained remote professionals to support your
                    operations? We build, train, and manage dedicated teams that
                    feel like your own.
                  </p>
                  <button
                    className="inline-flex items-center gap-2 px-6 py-3 text-white rounded-full text-sm font-extrabold transition-all hover:shadow-lg hover:scale-105 w-fit"
                    style={{
                      background: "var(--primary)",
            ...
            <Reveal direction="right" delay={0.08}>
              <div
                className="group relative rounded-3xl border border-white/10 p-8 transition-all duration-300 hover:shadow-2xl overflow-hidden h-full"
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  >
                    ...
                    <span className="text-xs font-extrabold text-violet-400 tracking-wide">
                      IntelliDesq™
                    </span>
                  </div>
                  ...
                  <p className="text-slate-400 font-light mb-6 leading-relaxed flex-1">
                    Want AI agents that work 24/7 without human intervention?
                    Deploy intelligent automation that never sleeps.
                  </p>
                  <button
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-sm font-extrabold border transition-all duration-200 hover:bg-primary hover:border-primary hover:text-white hover:shadow-lg w-fit"
                    style={{
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            <div className="text-center mb-16">
              <span className="text-xs font-extrabold uppercase tracking-[.22em] text-violet-400 block mb-3">
                The Process
              </span>
              <h2
              ...
              <p className="text-slate-400 font-light text-lg">
                A clear path from first contact to your custom solution.
              </p>
            </div>
          </Reveal>
            ...
            {nextSteps.map((item, i) => (
              <Reveal key={i} delay={i * 0.09} direction="up">
                <div className="relative text-center group cursor-default">
                  ...
                  <div
                    className="inline-flex items-center justify-center w-16 h-16 rounded-2xl text-white font-black text-lg mb-5 transition-transform group-hover:scale-110 duration-300"
                    style={{
                  ...
                  <h3 className="font-extrabold text-white mb-2 text-sm">
                    {item.title}
                  </h3>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <Reveal direction="left">
              <div>
                <span className="text-xs font-extrabold uppercase tracking-[.22em] text-primary block mb-4">
                  Why Us
                </span>
                <h2
                ...
                <p className="text-gray-500 font-light leading-relaxed text-lg">
                  We're not just a vendor — we're a growth partner. Here's what
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {whyPoints.map((item, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="flex items-start gap-3.5 p-4 rounded-2xl border border-gray-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 group cursor-default"
                    ...
                    >
                      ...
                      <p className="text-sm font-semibold text-gray-700 leading-snug pt-1">
                        {item.text}
                      </p>
                    </div>
                  );
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          <Reveal>
            ...
            <h2
              className="text-[clamp(2.5rem,6vw,5rem)] font-light text-white mb-5 leading-tight"
            ...
            <p className="text-slate-400 font-light text-lg mb-12 max-w-xl mx-auto leading-relaxed">
              Join businesses across the globe that trust AJAX Global to power
              their operations.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#contact-form"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full text-white font-extrabold transition-all duration-200 hover:scale-105 hover:shadow-2xl"
                style={{
                  background: "var(--primary)",
              ...
              <a
                href="#contact-form"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full border border-white/20 text-white font-extrabold hover:bg-white/10 hover:border-white/30 transition-all duration-200"
              >
                Request Pricing
              </a>
              <a
