      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          <h2 className="text-5xl md:text-6xl font-bold text-slate-900 tracking-tight leading-tight">
            Agentic <span className="text-blue-500">workflows</span> that <br /> run work end to end
          </h2>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex items-center gap-12 mb-8">
            <div className="hidden md:block text-right max-w-[180px]">
              ...
              <p className="text-xs text-slate-500">Set the event that kicks off the workflow</p>
            </div>
            <div className="bg-white border border-slate-200 rounded-lg p-4 shadow-sm flex items-center gap-3 w-64 ring-4 ring-green-500/10">
              <span className="bg-green-500 p-1 rounded text-white text-[10px]">⚡</span>
              <span className="text-sm font-medium">When ticket is created</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-12 mb-8">
            <div className="bg-white border border-slate-200 rounded-lg p-4 shadow-md flex items-center gap-3 w-72 border-b-4 border-b-purple-400">
               <span className="bg-purple-100 p-1.5 rounded text-purple-600">✨</span>
            ...
            <div className="hidden md:block max-w-[180px]">
              ...
              <p className="text-xs text-slate-500">Let AI run the logic, conditions and what happens next</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-12 pt-10">
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="bg-white border border-slate-200 rounded-lg p-3 w-full shadow-sm flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold uppercase text-slate-400">Escalation Caller Agent</span>
                </div>
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="bg-white border border-slate-200 rounded-lg p-3 w-full shadow-sm flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold uppercase text-slate-400">Ticket Resolver Agent</span>
                </div>
                <div className="bg-white border border-slate-200 rounded-lg p-3 w-full shadow-sm flex items-center gap-2">
