...
export default function HowWeWork() {
  ...
  return (
    <section className="py-24 sm:py-32 bg-[#f8f7ff]" ref={ref}>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {STEPS.map((s, i) => (
              ...
              >
                {/* Circle badge */}
                <div className="relative z-10 w-20 h-20 rounded-full flex items-center justify-center mb-6 ring-4 ring-white bg-primary/10 border-2 border-primary/25 flex-shrink-0">
                ...
                {/* Card */}
                <div className="bg-white rounded-2xl border border-gray-100 p-6 w-full shadow-sm group-hover:border-gray-200 group-hover:shadow-md transition-all duration-300 flex-1 flex flex-col justify-start">
                  ...
                  <p className="text-xs text-gray-400 font-light leading-relaxed mt-auto">{s.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
