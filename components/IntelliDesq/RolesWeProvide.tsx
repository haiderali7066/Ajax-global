...
const roles = [
  { icon: Cpu,         slug: "ai-automation",           title: "AI & Automation",          desc: "Intelligent workflows, zero manual overhead",    color: "#7c3aed", glow: "#7c3aed20" },
  { icon: Palette,     slug: "ui-ux-design",             title: "UI / UX Design",           desc: "Interfaces that convert and delight",            color: "#ec4899", glow: "#ec489920" },
  { icon: Code2,       slug: "web-development",          title: "Web Development",          desc: "Fast, scalable, and built to last",              color: "#2563eb", glow: "#2563eb20" },
  { icon: Smartphone,  slug: "mobile-app-development",   title: "Mobile App Development",   desc: "iOS & Android, shipped on time",                 color: "#059669", glow: "#05966920" },
  { icon: Fingerprint, slug: "brand-identity",           title: "Brand Identity",           desc: "Brands built to be remembered",                  color: "#d97706", glow: "#d9770620" },
  { icon: Map,         slug: "product-strategy",         title: "Product Strategy",         desc: "Roadmaps that align teams and ship value",       color: "#0ea5e9", glow: "#0ea5e920" },
  { icon: Search,      slug: "seo-content",              title: "SEO & Content",            desc: "Organic growth that compounds over time",        color: "#14b8a6", glow: "#14b8a620" },
  { icon: BarChart3,   slug: "data-analytics",           title: "Data & Analytics",         desc: "Turn your data into your unfair advantage",      color: "#8b5cf6", glow: "#8b5cf620" },
  { icon: TrendingUp,  slug: "growth-marketing",         title: "Growth Marketing",         desc: "Paid and organic engines, built to scale",       color: "#dc2626", glow: "#dc262620" },
  { icon: Server,      slug: "devops-infrastructure",    title: "DevOps & Infrastructure",  desc: "Ship faster with zero-downtime confidence",      color: "#94a3b8", glow: "#94a3b820" },
  { icon: Database,    slug: "crm-revops",               title: "CRM & RevOps",             desc: "Revenue systems that actually work together",    color: "#f59e0b", glow: "#f59e0b20" },
  { icon: Layers,      slug: "custom-solutions",         title: "Custom Solutions",         desc: "Built entirely around your problem",             color: "#6366f1", glow: "#6366f120" },
];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, #ec489908 0%, transparent 70%)", transform: "translate(50%, 40%)" }}
      />
