  ...
  const cases = [
    {
      ...
      dashStats: [
        ["Active SDRs", "18", "↑ from 11"],
        ["Leads Today", "142", "vs 98 avg"],
        ["Calls Made", "376", "↑ 24% WoW"],
        ["Pipeline", "$284k", "Target: $250k"],
      ],
      activity: [
        { msg: "New lead assigned to SDR — Acme Corp", ago: "just now" },
        { msg: "Deal closed — $18,400 contract signed", ago: "3 min ago" },
        { msg: "Monthly pipeline report generated", ago: "7 min ago" },
      ],
    },
    {
    ...
    },
    {
      ...
      dashStats: [
        ["Tasks Done", "531", "↑ from 410"],
        ["In Progress", "47", "on schedule"],
        ["Vendors Mgd", "23", "↑ 3 new"],
        ["Accuracy", "99.1%", "Target: 98%"],
      ],
      activity: [
        { msg: "Reconciliation report submitted for Q2", ago: "just now" },
        { msg: "New SOP created — Vendor Onboarding", ago: "4 min ago" },
        { msg: "Scheduling workflow updated for June", ago: "9 min ago" },
      ],
    },
    {
      ...
      dashStats: [
        ["Properties", "512", "↑ from 480"],
        ["Open Requests", "38", "↓ from 54"],
        ["Rent Collected", "97.4%", "Target: 95%"],
        ["Renewals", "84%", "↑ retention"],
      ],
      activity: [
        { msg: "Maintenance request escalated — Unit 4B", ago: "just now" },
        { msg: "Lease renewal sent to 12 tenants", ago: "6 min ago" },
        { msg: "Monthly rent collection report ready", ago: "11 min ago" },
      ],
    },
  ];
            ...
            <div className="relative rounded-2xl border border-gray-200 overflow-hidden bg-white shadow-xl" style={{ boxShadow: "0 20px 60px rgba(0,0,0,0.09)" }}>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  {c.dashStats.map(([label, val, note], i) => (
