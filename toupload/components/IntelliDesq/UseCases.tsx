...
const cases = [
  {
    ...
    dashStats: [
      ["Pipeline Value", "$1.2M", "↑ 32%"],
      ["Close Probability", "68%", "↑ 12%"],
      ["Deals Tracked", "94", "↑ 18%"],
      ["Forecast Accuracy", "91%", "Stable"],
    ],
  },
  {
    ...
    dashStats: [
      ["Tickets Resolved", "538", "↑ 23%"],
      ["Churn Risk Flagged", "14", "↓ -40%"],
      ["Avg Response", "1m 48s", "↓ improved"],
      ["CSAT Score", "98.1%", "Target: 95%"],
    ],
  },
  {
    ...
    dashStats: [
      ["Workflows Active", "27", "↑ 8 new"],
      ["Bottlenecks Found", "5", "↓ from 13"],
      ["Resource Util.", "87%", "↑ optimized"],
      ["Cost Saved", "$48k", "This month"],
    ],
  },
  {
    ...
    dashStats: [
      ["Reports Generated", "312", "↑ 18%"],
      ["Prediction Horizon", "14 days", "Stable"],
      ["Alerts Fired", "7", "↓ -40%"],
      ["Decisions Aided", "1,847", "↑ 23%"],
    ],
  },
];
