    ...
    >
      ...
      >
        ...
        >
                  ...
                  >
                    ...
                    <div className="w-28 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                      <motion.div
                        ...
                        transition={{ delay: 1.1 + i * 0.09, duration: 0.9, ease: "easeOut" }}
                      />
                    </div>
          ...
          >
            <div className="bg-white rounded-2xl border border-gray-200 shadow-xl p-4 w-48" style={{ boxShadow: "0 12px 40px rgba(0,0,0,0.1)" }}>
          ...
          >
            <div className="bg-white rounded-2xl border border-gray-200 shadow-xl p-4 w-52" style={{ boxShadow: "0 12px 40px rgba(0,0,0,0.1)" }}>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <motion.div variants={fadeUp} initial="hidden" animate={inView ? "show" : "hidden"} className="text-center mb-12">
          ...
          <p className="text-gray-400 font-light mt-3 max-w-lg mx-auto text-sm">
            Businesses invest heavily in tools — yet still struggle with slow decisions, disconnected processes, and blind spots. The missing piece? An intelligence layer.
          </p>
        </motion.div>
        <div className="grid lg:grid-cols-2 gap-10">
          <motion.div variants={slideLeft} initial="hidden" animate={inView ? "show" : "hidden"} className="space-y-4">
            <p className="text-sm font-semibold text-gray-500 mb-5">What you have now:</p>
            {old.map((o, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 font-light mt-0.5">{o.desc}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            <p className="text-sm font-semibold text-gray-800 mb-5">What your business is missing:</p>
            <div className="space-y-3">
              {pains.map((p, i) => (
                ...
                >
                  ...
                  <span className="text-sm text-gray-500 font-light leading-relaxed">{p}</span>
                </motion.div>
              ))}
            </div>
...
function WhatIsIntelliDesq() {
  ...
  return (
    <section
      className="relative py-16 sm:py-20 mx-10 rounded-[2.5rem] bg-slate-900 border border-slate-800 shadow-2xl overflow-hidden"
      ref={ref}
    >
              ...
              {rings.map((size, i) => (
                <motion.div
                  ...
                  style={{
                    ...
                    marginTop: -size, marginLeft: -size,
                ...
                >
                  <div
                    ...
                    style={{
                      background: i === 0 ? "#8b5cf6" : i === 1 ? "#38bdf8" : "#34d399",
                      color: i === 0 ? "#8b5cf6" : i === 1 ? "#38bdf8" : "#34d399",
                    }}
                  />
                </motion.div>
              ))}
              <div className="absolute -right-4 top-1/4 text-xs sm:text-sm font-medium text-slate-200 bg-slate-800/80 backdrop-blur-md rounded-xl px-4 py-2 border border-slate-600 shadow-[0_4px_20px_rgba(0,0,0,0.3)] z-30">Observes</div>
              <div className="absolute -left-4 top-1/2 text-xs sm:text-sm font-medium text-slate-200 bg-slate-800/80 backdrop-blur-md rounded-xl px-4 py-2 border border-slate-600 shadow-[0_4px_20px_rgba(0,0,0,0.3)] z-30">Analyzes</div>
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-xs sm:text-sm font-medium text-slate-200 bg-slate-800/80 backdrop-blur-md rounded-xl px-4 py-2 border border-slate-600 shadow-[0_4px_20px_rgba(0,0,0,0.3)] z-30">Optimizes</div>
            </div>
          </motion.div>
        </div>
      </div>
    ...
    <section className="py-16 sm:py-20 bg-white" ref={ref}>
      <div className="max-w-6xl mx-auto px-6">
        <motion.div variants={fadeUp} initial="hidden" animate={inView ? "show" : "hidden"} className="text-center mb-16">
          <h2 className="text-[clamp(2rem,4.5vw,3.5rem)] font-light text-gray-900" style={{ letterSpacing: "-0.02em" }}>
            How <span className="bg-primary text-white px-2 rounded-lg">IntelliDesq™</span> works
          </h2>
        </motion.div>
        <div className="relative">
          <div className="hidden lg:block absolute top-10 left-[12.5%] right-[12.5%] h-px bg-gray-100 overflow-hidden">
            <motion.div
              className="h-full"
              style={{ background: "linear-gradient(90deg,#7c3aed,#4f46e5,#0ea5e9,#10b981)", transformOrigin: "left" }}
              initial={{ scaleX: 0 }}
...
function IntelliDesqPlusHOS() {
  ...
  return (
    <section className="py-16 sm:py-20 relative overflow-hidden" style={{ background: "#022c22" }} ref={ref}>
      <div
            ...
            >
              ...
              <div className="p-8 text-center space-y-7">
                <div className="flex items-center justify-center gap-6">
                  <motion.div className="w-16 h-16 rounded-2xl flex items-center justify-center border border-white/[0.08]" style={{ background: "rgba(16,185,129,0.2)" }} animate={{ rotate: [0, 4, -4, 0] }} transition={{ duration: 5, repeat: Infinity }}>
                  ...
                  <motion.div className="w-16 h-16 rounded-2xl flex items-center justify-center border border-white/[0.08]" style={{ background: "rgba(20,184,166,0.2)" }} animate={{ rotate: [0, -4, 4, 0] }} transition={{ duration: 5, repeat: Infinity, delay: 0.5 }}>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[["10×","Speed","#34d399"],["40%","Savings","#2dd4bf"],["98%","Quality","#a3e635"]].map(([v,l,c]) => (
                    <motion.div
                      ...
                      whileHover={{ scale: 1.07, background: "rgba(16,185,129,0.15)" }}
                    >
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div
              ...
              style={{ borderColor: `${c.color}20`, boxShadow: `0 20px 60px ${c.color}10` }}
            >
  ...
  return (
    <section className="py-16 sm:py-20" style={{ background: "#f8f7ff" }} ref={ref}>
      <div className="max-w-6xl mx-auto px-6">
        <motion.div variants={fadeUp} initial="hidden" animate={inView ? "show" : "hidden"} className="text-center mb-16">
          <h2 className="text-[clamp(2rem,4.5vw,3.5rem)] font-light text-gray-900" style={{ letterSpacing: "-0.02em" }}>
            Features that <span className="bg-red-800 text-white px-2 rounded-lg">change everything</span>
          </h2>
        </motion.div>
  ...
  return (
    <section className="py-16 sm:py-20 bg-white" ref={ref}>
      <div className="max-w-6xl mx-auto px-6">
        <motion.div variants={fadeUp} initial="hidden" animate={inView ? "show" : "hidden"} className="text-center mb-12">
          <h2 className="text-[clamp(2rem,4.5vw,3.5rem)] font-light text-gray-900" style={{ letterSpacing: "-0.02em" }}>
            Real <span className="bg-primary text-white px-2 rounded-lg">performance</span> numbers
          </h2>
...
function Integrations() {
  ...
  return (
    <section className="relative py-16 sm:py-20 mx-10 rounded-3xl overflow-hidden bg-black border border-zinc-800 shadow-2xl" ref={ref}>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <motion.p variants={fadeUp} initial="hidden" animate={inView ? "show" : "hidden"} className="text-center text-sm text-slate-400 font-normal mt-10 tracking-wide">
...
function IntelliDesqCTA() {
  ...
  return (
    <section className="py-20 sm:py-28 relative overflow-hidden bg-white" ref={ref}>
      <div
        className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 80% 70% at 50% 50%, rgba(124,58,237,0.07) 0%, transparent 70%)" }}
      />
      <div
        className="absolute inset-0 pointer-events-none"
      ...
      <div className="absolute right-20 bottom-1/4 opacity-50 hidden lg:block" style={{ animation: "floatA 9s ease-in-out infinite 1s" }}>
